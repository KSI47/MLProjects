...
data_model=data.filter(['X19','X20','X21','X22','X23','X24','Phase']) #select all model parameters
X=data_model.drop(['Phase'], axis=1) #select features
Y=data_model['Phase'] # select labels
...
data_test=data_test.filter(['X19','X20','X21','X22','X23','X24','Phase']) # select features and labels
